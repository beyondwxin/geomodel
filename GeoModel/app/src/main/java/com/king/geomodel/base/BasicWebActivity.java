...
import com.king.geomodel.utils.MyUtils;
import com.king.geomodel.utils.StringUtil;
import com.king.geomodel.view.HProgressBarLoading;
...
public class BasicWebActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       findViewById(R.id.iv_left).setOnClickListener(new View.OnClickListener() {
        ...
        ((TextView)findViewById(R.id.tv_actionBarTitle)).setText(getIntent().getStringExtra("title"));
        initWebSetting();
    }
    ...
    private void initWebSetting() {
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public void onProgressChanged(WebView view, int newProgress) {
                ...
                //如果没有网络直接跳出方法
                if (!MyUtils.isNetworkAvailable(BasicWebActivity.this)) {
                    return;
                }
                //如果进度条隐藏则让它显示
        ...
        //开始加载
        webView.loadUrl(StringUtil.getCorrectUrl(getIntent().getStringExtra("url")));
    }
    ...
    private void hideProgressWithAnim() {
        AnimationSet animation = getDismissAnim(BasicWebActivity.this);
