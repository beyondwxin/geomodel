...
public class GetObjectSamples {
    ...
    public GetObjectSamples(OSS client, String testBucket, String objectKey) {
        this.oss = client;
    ...
    public void getObjectSample() {
        ...
        // 构造下载文件请求
        GetObjectRequest get = new GetObjectRequest(testBucket, objectKey);
        ...
        OSSAsyncTask task = oss.asyncGetObject(get, new OSSCompletedCallback<GetObjectRequest, GetObjectResult>() {
            ...
            public void onSuccess(GetObjectRequest request, GetObjectResult result) {
                ...
                try {
                    ...
                    Log.e("imageByteArray",imageByteArray.length+"");
                    outStream.close();
                    Log.d("asyncGetObjectSample", "download success.");
                } catch (IOException e) {
                    e.printStackTrace();
